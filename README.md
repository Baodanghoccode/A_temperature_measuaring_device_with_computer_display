...
5. **Host Communication:** UART (9600 baud) streams data to a PC, where a Python GUI parses and displays it live.
...
| Power         | 3x 18650 Li-ion                             | Power supply                       |
